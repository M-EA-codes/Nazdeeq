...
export default function MyRides() {
  ...
  const renderRide = ({ item }: { item: typeof myRides[0] }) => (
    <LinearGradient
      colors={["#fff", "#f3f3ff"]}
    ...
    >
      <View style={styles.rideCardRow}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.rideType}>
            {item.type === 'offered' ? 'Offered Ride' : 'Joined Ride'}
          </Text>
      ...
      <View style={styles.rideDetailsRow}>
        ...
        <View style={styles.rideDetailItem}>
          ...
          <Text style={[styles.rideDetailText, { color: item.status === 'completed' ? '#3ad29f' : '#7f53ac' }]}>
    ...
    <LinearGradient colors={["#e0c3fc", "#8ec5fc"]} style={styles.gradient}>
      <View style={styles.container}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={{ color: '#23235b', textAlign: 'center', marginTop: 30 }}>
              No rides found.
            </Text>
          }
        />
